...
<div class="topnav">
  ...
  <a href="index.php" style="float:right">Contact Us</a>
  <a href="aboutus.html" style="float:right">About Us</a>
  <a href="gallerynew.html" style="float:right">Gallery</a>
	...
	<button type="submit" class="btn btn-primary">Sign Up</button><br><br>
	 ...
	 <footer>
        <div class="footer-bottom">
            <h6>copyright &copy;2021 BMCC Placement Cell. designed by Group I</h6>
        </div>
    </footer>
</div>
</body>
